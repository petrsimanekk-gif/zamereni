...
@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact}.page{padding:20px}.print-bar{display:none}}
.print-bar{position:fixed;bottom:0;left:0;right:0;background:#fff;border-top:2px solid #cb1419;padding:14px 24px;display:flex;align-items:center;gap:16px;box-shadow:0 -4px 16px rgba(0,0,0,.1)}
...
<div class="page">
  ...
  <div style="margin-top:20px;background:#fdecea;border-radius:8px;padding:14px 18px;display:flex;align-items:center;justify-content:space-between">
    ...
    <div class="sign-line" style="border-top:1px solid #cb1419;width:180px;text-align:center;padding-top:6px;font-size:11px;color:#888">Podpis technika</div>
  </div>
</div>
